...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*MADE BY YOUR PROFESSOR*' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? 923269464895@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? 923269464895' : process.env.ALL_NUMBER,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ᴘʀᴏꜰᴇꜱꜱᴏʀ¹¹;𝓟𝓻𝓸𝓯𝓮𝓼𝓼𝓸𝓻 𝓳𝓲𝓷;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'ᴘʀᴏꜰᴇꜱꜱᴏʀ' : process.env.OWNER_NAME,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/shakargarhaaly' : process.env.IG,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'ᴘʀᴏꜰᴇꜱꜱᴏʀ|𝓟𝓻𝓸𝓯𝓮𝓼𝓼𝓸𝓻 𝓳𝓲𝓷' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'ᴘʀᴏꜰᴇꜱꜱᴏʀ' : process.env.AUTO_FAKE,
    ...
    SKV: process.env.V_HEADER === undefined ? '*Legends Never Die*' : process.env.V_HEADER,
    SKDR: process.env.DURATION === undefined ? '99978509' : process.env.DURATION,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? 923269464895' : process.env.YAK,
    sourav_g_link: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/LZrLqfirBm55yNNYhmwuh6' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
